...
# Тк буду использовать динамический массив, по идее надо вводить емкость массива. То есть размер стека будет отражать size массива, а массив при этом имеет capacity >= size
#Пока мне неясно как обращаться к верхушке стека (хвосту массива) как к дну стека (голове массива) - еслия верно понял вопрос.

# вижу так: сначала ввожу класс динамического массива, ввожу под него методы. Далее использую этот класс в классе стека. Звучит вроде как логично
